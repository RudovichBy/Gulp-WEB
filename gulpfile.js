var gulp       		= require('gulp'), // Подключаем Gulp
	...
	notify			= require('gulp-notify'),	//Сообщения об ошибках и предупреждениях об ошибках
	plumber			= require('gulp-plumber'),	//Предотвращает падение(зависание) GULP при ошибках
...
gulp.task('less', function(){ // Создаем таск less
	return gulp.src('app/less/*.less') // Берем источник
		...
		})) //Предотвращает падение(зависание) GULP при ошибках
